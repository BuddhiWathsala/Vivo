            ...
            if(isset($photographers))
            {
              ...
              foreach ($photographers as $single_photographer)
              {
                if($i%3 == 0)
                {
                  ...
                  echo "<strong>Mobile : </strong>".$single_photographer->mobile_phone."<br />";
                  echo "<strong>Land phone : </strong>".$single_photographer->land_phone."<br />";
                  echo "<strong>District : </strong>".$single_photographer->district."<br />";
                  echo "<strong>Category : </strong>".$categories[$single_photographer->category]."<br />";
