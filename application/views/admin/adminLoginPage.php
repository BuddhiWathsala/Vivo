...
<?php
  ...
  {
    echo "<script type='text/javascript'>alert('".$_SESSION['loginMessage']."')</script>";
...
<body>
  ...
  <div class="wrapper">
  <form action="<?php echo base_url();?>index.php/C_Admin_Forms/adminLogin/" class="login" method="post">
